...
def main():
    ...
    parser.add_argument('--dataset_path', default='/exp/dataset/imagenet', type=str)
    ...
    save_dir = '/exp/resnet_tutorial/saved_models'
    ...
    # ddp 일때만 learning rate 조정
    args.lr = args.lr * hvd.size()
    # train_sampler 는 ddp 일때만 사용
    ...
    # # single GPU 1/2
    # model = model.cuda('cuda:0')    # single GPU
    # device = 'cuda:0'
    # criterion = nn.CrossEntropyLoss().to(device)

    # DP(multi-threading) 1/2 코드
